	...
	struct record *rec;
{
	...
	if ((rec->rec_award == NEBULA) || (rec->rec_award == NEBULAWIN))
		printf("Nebula  ");
	else if ((rec->rec_award == HUGO) || (rec->rec_award == HUGOWIN))
		printf("Hugo    ");
	else if ((rec->rec_award == LOCUS) || (rec->rec_award == LOCUSWIN))
		printf("Locus   ");
